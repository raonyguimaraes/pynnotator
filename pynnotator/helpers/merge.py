...
class Merge(object):
    def __init__(self, vcffile=None):
        ...
        # pysam.tabix_index('../hgmd/hgmd.vcf', preset='vcf')

        # if os.path.isfile(settings.hgmd_file):
        #     self.annotation_files['hgmd'] = {
        #         'info': 'CLASS,MUT,GENE,STRAND,DNA,PROT,PHEN',            'file': pysam.Tabixfile('../hgmd/hgmd.vcf.gz', 'r', encoding="utf-8")
        #     }
